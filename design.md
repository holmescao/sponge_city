...
### 4. 结果保存：单位面积污染过程（一场雨）[undo]
5种污染物的过程曲线

### 5. 更新readme [undo]

### 6. 未来：雨前干旱时间，和对应的初始污染物累积量 [undo]
...
## 2022年09月24日 [undo]
### 1. 雨型在初始的时候尺寸有问题 [undo]
- [ ] 图像尺寸会很小，但是调整参数后又正常

### 2. 面源斑块选择`请选择`会闪退 [undo]

### 3. 软件的结构模块封装 [undo]
- [ ] 尤其是主函数现在1k+行，需要封装成模块
