...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_SpongeBlock = QAction(MainWindow)
        self.action_SpongeBlock.setObjectName(u"action_SpongeBlock")
        self.action_sim_sponge_block = QAction(MainWindow)
        self.action_sim_sponge_block.setObjectName(u"action_sim_sponge_block")
        self.action_rain_generate = QAction(MainWindow)
        self.action_rain_generate.setObjectName(u"action_rain_generate")
        ...
        self.horizontalLayout_10 = QHBoxLayout(self.tab_single_block)
        ...
        self.verticalLayout_4 = QVBoxLayout(self.tab_block_rainfall)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.horizontalLayout = QHBoxLayout()
        self.horizontalLayout.setSpacing(5)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setSizeConstraint(QLayout.SetMinAndMaxSize)
        self.block_rainfall_sim_res_rainfall = QGraphicsView(self.tab_block_rainfall)
        ...
        self.block_rainfall_sim_res_runoff = QGraphicsView(self.tab_block_rainfall)
        ...
        self.block_rainfall_sim_res_runoff.setBackgroundBrush(brush2)
        brush3 = QBrush(QColor(255, 255, 255, 255))
        brush3.setStyle(Qt.NoBrush)
        self.block_rainfall_sim_res_runoff.setForegroundBrush(brush3)

        self.horizontalLayout.addWidget(self.block_rainfall_sim_res_runoff)

        self.block_rainfall_sim_res_pollution = QGraphicsView(self.tab_block_rainfall)
        ...
        self.block_rainfall_sim_res_pollution.setBackgroundBrush(brush4)
        brush5 = QBrush(QColor(255, 255, 255, 255))
        brush5.setStyle(Qt.NoBrush)
        self.block_rainfall_sim_res_pollution.setForegroundBrush(brush5)
        ...
        self.tab_sponge_block = QWidget()
        self.tab_sponge_block.setObjectName(u"tab_sponge_block")
        self.horizontalLayout_9 = QHBoxLayout(self.tab_sponge_block)
        self.horizontalLayout_9.setObjectName(u"horizontalLayout_9")
        self.tabWidget_sponge_block_res = QTabWidget(self.tab_sponge_block)
        self.tabWidget_sponge_block_res.setObjectName(u"tabWidget_sponge_block_res")
        self.tab_sponge_block_rainfall = QWidget()
        self.tab_sponge_block_rainfall.setObjectName(u"tab_sponge_block_rainfall")
        self.horizontalLayout_7 = QHBoxLayout(self.tab_sponge_block_rainfall)
        self.horizontalLayout_7.setObjectName(u"horizontalLayout_7")
        self.scrollArea = QScrollArea(self.tab_sponge_block_rainfall)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1180, 1300))
        ...
        self.sponge_block_rainfallrunoff_sim_res_rainfall = QGraphicsView(self.scrollAreaWidgetContents)
        self.sponge_block_rainfallrunoff_sim_res_rainfall.setObjectName(u"sponge_block_rainfallrunoff_sim_res_rainfall")
        sizePolicy3.setHeightForWidth(self.sponge_block_rainfallrunoff_sim_res_rainfall.sizePolicy().hasHeightForWidth())
        self.sponge_block_rainfallrunoff_sim_res_rainfall.setSizePolicy(sizePolicy3)
        brush6 = QBrush(QColor(255, 255, 255, 255))
        brush6.setStyle(Qt.NoBrush)
        self.sponge_block_rainfallrunoff_sim_res_rainfall.setBackgroundBrush(brush6)
        brush7 = QBrush(QColor(255, 255, 255, 255))
        brush7.setStyle(Qt.NoBrush)
        self.sponge_block_rainfallrunoff_sim_res_rainfall.setForegroundBrush(brush7)

        self.horizontalLayout_4.addWidget(self.sponge_block_rainfallrunoff_sim_res_rainfall)

        self.sponge_block_pollution_sim_res_rainfall_SS = QGraphicsView(self.scrollAreaWidgetContents)
        self.sponge_block_pollution_sim_res_rainfall_SS.setObjectName(u"sponge_block_pollution_sim_res_rainfall_SS")
        sizePolicy3.setHeightForWidth(self.sponge_block_pollution_sim_res_rainfall_SS.sizePolicy().hasHeightForWidth())
        self.sponge_block_pollution_sim_res_rainfall_SS.setSizePolicy(sizePolicy3)
        brush8 = QBrush(QColor(255, 255, 255, 255))
        brush8.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_SS.setBackgroundBrush(brush8)
        brush9 = QBrush(QColor(255, 255, 255, 255))
        brush9.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_SS.setForegroundBrush(brush9)
        ...
        self.sponge_block_pollution_sim_res_rainfall_COD = QGraphicsView(self.scrollAreaWidgetContents)
        self.sponge_block_pollution_sim_res_rainfall_COD.setObjectName(u"sponge_block_pollution_sim_res_rainfall_COD")
        sizePolicy3.setHeightForWidth(self.sponge_block_pollution_sim_res_rainfall_COD.sizePolicy().hasHeightForWidth())
        self.sponge_block_pollution_sim_res_rainfall_COD.setSizePolicy(sizePolicy3)
        brush10 = QBrush(QColor(255, 255, 255, 255))
        brush10.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_COD.setBackgroundBrush(brush10)
        brush11 = QBrush(QColor(255, 255, 255, 255))
        brush11.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_COD.setForegroundBrush(brush11)

        self.horizontalLayout_5.addWidget(self.sponge_block_pollution_sim_res_rainfall_COD)

        self.sponge_block_pollution_sim_res_rainfall_TP = QGraphicsView(self.scrollAreaWidgetContents)
        self.sponge_block_pollution_sim_res_rainfall_TP.setObjectName(u"sponge_block_pollution_sim_res_rainfall_TP")
        sizePolicy3.setHeightForWidth(self.sponge_block_pollution_sim_res_rainfall_TP.sizePolicy().hasHeightForWidth())
        self.sponge_block_pollution_sim_res_rainfall_TP.setSizePolicy(sizePolicy3)
        brush12 = QBrush(QColor(255, 255, 255, 255))
        brush12.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_TP.setBackgroundBrush(brush12)
        brush13 = QBrush(QColor(255, 255, 255, 255))
        brush13.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_TP.setForegroundBrush(brush13)
        ...
        self.sponge_block_pollution_sim_res_rainfall_TN = QGraphicsView(self.scrollAreaWidgetContents)
        self.sponge_block_pollution_sim_res_rainfall_TN.setObjectName(u"sponge_block_pollution_sim_res_rainfall_TN")
        sizePolicy3.setHeightForWidth(self.sponge_block_pollution_sim_res_rainfall_TN.sizePolicy().hasHeightForWidth())
        self.sponge_block_pollution_sim_res_rainfall_TN.setSizePolicy(sizePolicy3)
        brush14 = QBrush(QColor(255, 255, 255, 255))
        brush14.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_TN.setBackgroundBrush(brush14)
        brush15 = QBrush(QColor(255, 255, 255, 255))
        brush15.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_TN.setForegroundBrush(brush15)

        self.horizontalLayout_6.addWidget(self.sponge_block_pollution_sim_res_rainfall_TN)

        self.sponge_block_pollution_sim_res_rainfall_NH3N = QGraphicsView(self.scrollAreaWidgetContents)
        self.sponge_block_pollution_sim_res_rainfall_NH3N.setObjectName(u"sponge_block_pollution_sim_res_rainfall_NH3N")
        sizePolicy3.setHeightForWidth(self.sponge_block_pollution_sim_res_rainfall_NH3N.sizePolicy().hasHeightForWidth())
        self.sponge_block_pollution_sim_res_rainfall_NH3N.setSizePolicy(sizePolicy3)
        brush16 = QBrush(QColor(255, 255, 255, 255))
        brush16.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_NH3N.setBackgroundBrush(brush16)
        brush17 = QBrush(QColor(255, 255, 255, 255))
        brush17.setStyle(Qt.NoBrush)
        self.sponge_block_pollution_sim_res_rainfall_NH3N.setForegroundBrush(brush17)
        ...
        self.tab_sponge_block_month = QWidget()
        self.tab_sponge_block_month.setObjectName(u"tab_sponge_block_month")
        self.tabWidget_sponge_block_res.addTab(self.tab_sponge_block_month, "")
        self.tab_sponge_block_year = QWidget()
        self.tab_sponge_block_year.setObjectName(u"tab_sponge_block_year")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_SpongeBlock.setText(QCoreApplication.translate("MainWindow", u"\u6d77\u7ef5\u5730\u5757", None))
        self.action_sim_sponge_block.setText(QCoreApplication.translate("MainWindow", u"\u6d77\u7ef5\u5730\u5757", None))
        self.action_rain_generate.setText(QCoreApplication.translate("MainWindow", u"\u96e8\u578b\u751f\u6210", None))
        ...
        self.tabWidget_sponge_block_res.setTabText(self.tabWidget_sponge_block_res.indexOf(self.tab_sponge_block_rainfall), QCoreApplication.translate("MainWindow", u"\u573a\u6b21\u964d\u96e8", None))
        self.tabWidget_sponge_block_res.setTabText(self.tabWidget_sponge_block_res.indexOf(self.tab_sponge_block_month), QCoreApplication.translate("MainWindow", u"\u6708\u5ea6", None))
        self.tabWidget_sponge_block_res.setTabText(self.tabWidget_sponge_block_res.indexOf(self.tab_sponge_block_year), QCoreApplication.translate("MainWindow", u"\u5e74\u5ea6", None))
        self.tabWidget_single_sponge_res.setTabText(self.tabWidget_single_sponge_res.indexOf(self.tab_sponge_block), QCoreApplication.translate("MainWindow", u"\u6d77\u7ef5\u5730\u5757", None))
