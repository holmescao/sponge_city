...
class Ui_SimDates(object):
    def setupUi(self, SimDates):
        ...
        self.dateTime_start_edit.setDateTime(QDateTime(QDate(2021, 5, 25), QTime(10, 0, 0)))
        ...
        self.dateTime_end_edit.setDateTime(QDateTime(QDate(2021, 5, 25), QTime(23, 0, 0)))
        self.dateTime_end_edit.setDate(QDate(2021, 5, 25))
        ...
        self.spinBox_timestep.setValue(60)
